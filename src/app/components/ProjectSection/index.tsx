        ...
        {fullWidth ?
            <Section width="w-full" className="flex flex-col items-center" px="px-0">
                ...
                {smallImage && <div className="w-full grid place-items-center">
                    <Image src={`/projects/${projectname}${smallImage}`} width={1920} height={1080} className="w-full md:max-w-7xl px-5 2xl:px-0 col-span-2 items-center" alt={`Image of ${projectname}`} />
                </div>}
                            ...
                            {solution &&
                                <>
                                    ...
                                    {solution?.solutions.map((solutions: any, index: number) => (
                                        <div key={index} className="grid grid-cols-1 md:grid-cols-[15%_85%] gap-2">
                                            <div className="font-light">
                                                0{index + 1}
                                            </div>
                                            <div className="flex flex-col gap-2">
                                                <p className="font-bold">{solutions.feature}</p>
